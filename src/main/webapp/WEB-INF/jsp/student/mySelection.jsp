...
<div class="app-title">
    <div>
        <a>&nbsp;</a>
        <h1><i class="fa fa-th-list">My Selection</i></h1>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
                ...
                <div id="sampleTable_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6"><div class="dataTables_length" id="sampleTable_length">
                            ...
                            <div class="btn-group">
                                ...
                                <a href="/student/mySelection" class="btn btn-primary">
                                    <i class="Hui-iconfont">&#xe68f;</i></a>
                            </div></div>
                        </div>
                    ...
                    <div class="row"><div class="col-sm-12">
                        <table class="table table-hover table-bordered dataTable no-footer" id="sampleTable" role="grid" aria-describedby="sampleTable_info">
                            ...
                            <tbody>
                            <c:forEach var="se" items="${selections}" varStatus="sta" begin="0" step="1">
                            <tr role="row" class="odd"
                                <c:if test="${sta.count%2==1}">bgcolor="#B0C4DE"</c:if>>
                                <td>
                                    <div class="animated-checkbox"><label>
                                        <input type="checkbox" id="ids" name="ids"><span class="label-text"></span>
                                    </label></div></td>
                                ...
                                <td>
                                    <c:if test="${se.selection_status == 0}">
                                        <a title="退选" style="text-decoration:none" href="javascript:;"
                                           onclick="selection_delete(this,${se.selection_id})">
                                        <i class="Hui-iconfont" style="font-size:20px">&#xe6dd;</i>&nbsp;&nbsp;</a>
                                    </c:if>
                                    <c:if test="${se.selection_status == 2}">
                                        <a title="删除" style="text-decoration:none" href="javascript:;"
                                           onclick="selection_delete(this,${se.selection_id})">
                                            <i class="Hui-iconfont" style="font-size:20px">&#xe609;</i>&nbsp;&nbsp;</a>
                                    </c:if>
                                </td>
...
<script type="text/javascript">
    /*退选课程*/
    function selection_delete(obj, id) {
        layer.confirm('确认退选该课程吗？', function (index) {
            ...
            $(obj).remove();
            layer.msg('课程已退选', {icon: 6, time: 1000});
