...
<body>
    <div class="col-md-6">
        <div class="tile">
            ...
            <div class="tile-body">
                <form class="form-horizontal" action="${pageContext.request.contextPath}/student/${url}" method="post" enctype="multipart/form-data" onsubmit="return check()">
                    ...
                    <div class="tile-footer">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-3">
                                ...
                                <a class="btn btn-secondary" href="/student/list">
