    ...
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl">
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    <li><i class="Hui-iconfont">&#xe62d;</i>  管理员</li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li><a data-href="/student/list" data-title="学生信息" >学生信息</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a data-href="/course/list" data-title="课程信息" >课程信息</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-member2">
            ...
            <dd>
                <ul>
                    <li><a data-href="/selection/list" data-title="学生选课信息" href="javascript:;">学生选课信息</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="/order/list" data-title="订单列表" >订单列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-system">
