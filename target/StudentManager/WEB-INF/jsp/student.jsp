            ...
            <div class="tile-body">
                <div id="sampleTable_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6"><div class="dataTables_length" id="sampleTable_length">
                            <label>Show
                                <select onchange="window.location=this.value;" name="select"
                                    ...
                                    <option value="/studentList?rows=5">5</option>
                                    <option value="/studentList?rows=10">10</option>
                                    <option value="/studentList?rows=20">20</option>
                                    <option value="/studentList?rows=50">50</option>
                        ...
                        <label>
                            <form action="${pageContext.request.contextPath}/studentList" method="post" onsubmit="return check()">
                        ...
                        <%--
                            显示表单数据
                        --%>
                    <form action="${pageContext.request.contextPath}/deleteStudents" method="post">
                    <div class="row"><div class="col-sm-12">
                        <table class="table table-hover table-bordered dataTable no-footer" id="sampleTable" role="grid" aria-describedby="sampleTable_info">
                            ...
                            <tr role="row" class="odd"
                                ...
                                <td>${st.phone}</td>
                                <td>${st.address}</td>
                                <td><a style="text-decoration:none" href="/editStudent?id=${st.sno}"><i class="Hui-iconfont">&#xe6df;</i>&nbsp;&nbsp;</a>
                                    <a style="text-decoration:none" href="/deleteStudent?id=${st.sno}"><i class="Hui-iconfont">&#xe609;</i>&nbsp;&nbsp;</a></td>
                            </tr>
                            </c:forEach>
                            </tbody>
                        </table>
                        ...
                        <div class="dataTables_info" id="sampleTable_info" role="status" aria-live="polite">
                            ...
                            <div style="float:right">
                                <ul class="pagination">
                                    <itheima:page url="${pageContext.request.contextPath}/studentList"/>
                                </ul>
                            </div>
                </div></div></div>
                    </form>
